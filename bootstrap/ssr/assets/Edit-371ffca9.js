...
import _sfc_main$4 from "./DeleteUserForm-f6c2c08d.js";
import _sfc_main$3 from "./UpdatePasswordForm-0d4e4bb2.js";
import _sfc_main$2 from "./UpdateProfileInformationForm-0eb5dcde.js";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg"${_scopeId}><h2${_scopeId}>Мої курси</h2></div><div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg"${_scopeId}>`);
