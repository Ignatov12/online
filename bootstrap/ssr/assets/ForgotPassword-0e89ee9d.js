      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mb-4 text-sm text-white"${_scopeId}> Забули свій пароль? Без проблем. Просто повідомте нам свою електронну адресу, і ми надішлемо вам електронною поштою посилання для скидання пароля, за яким ви зможете вибрати новий. </div>`);
            if (__props.status) {
            ...
            _push2(ssrRenderComponent(PrimaryButton, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Посилання для відновлення пароля електронної пошти `);
                } else {
                  return [
                    createTextVNode(" Посилання для відновлення пароля електронної пошти ")
                  ];
                }
              }),
              _: 1
            ...
            return [
              ...
              createVNode("div", { class: "mb-4 text-sm text-white" }, " Забули свій пароль? Без проблем. Просто повідомте нам свою електронну адресу, і ми надішлемо вам електронною поштою посилання для скидання пароля, за яким ви зможете вибрати новий. "),
