    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Підтвердити пароль" }, null, _parent2, _scopeId));
            _push2(`<div class="mb-4 text-sm text-gray-600"${_scopeId}> Це безпечна область програми. Перш ніж продовжити, підтвердьте свій пароль. </div><form${_scopeId}><div${_scopeId}>`);
            ...
            return [
              createVNode(unref(Head), { title: "Підтвердити пароль" }),
              createVNode("div", { class: "mb-4 text-sm text-gray-600" }, " Це безпечна область програми. Перш ніж продовжити, підтвердьте свій пароль. "),
              createVNode("form", {
